...
(function (window){
	...
	var FWDR3DCarComboBox = function(parent, props_obj){
		
		var self = this;
		var prototype = FWDR3DCarComboBox.prototype;
		...
		this.setupMainContainers = function(){
			...
			self.selector_do.addListener(FWDR3DCarComboBoxSelector.MOUSE_DOWN, self.openMenuHandler);
			
			for(var i=0; i<self.totalButtons; i++){
				FWDR3DCarComboBoxButton.setPrototype();
				button_do = new FWDR3DCarComboBoxButton(
				...
				button_do.addListener(FWDR3DCarComboBoxButton.MOUSE_DOWN, self.buttonOnMouseDownHandler);
		...
		this.buttonOnMouseDownHandler = function(e){
			...
			self.dispatchEvent(FWDR3DCarComboBox.BUTTON_PRESSED, {id:self.curId});
		};
		...
		this.openMenuHandler = function(){
			...
			self.dispatchEvent(FWDR3DCarComboBox.OPEN);
		};
		...
		this.checkOpenedMenu = function(e){
			...
			if(!FWDR3DCarUtils.hitTest(self.screen, viewportMouseCoordinates.screenX, viewportMouseCoordinates.screenY)){
		...
		this.showFirstTime = function(){
			...
			FWDR3DCarModTweenMax.to(self.mainHolder_do, .8, {y:0, ease:Expo.easeInOut});	
		};
		...
		this.hide = function(animate, overwrite){
			...
			if(animate){
				FWDR3DCarModTweenMax.to(self.buttonsHolder_do, .6, {y:- self.totalButtonsHeight, ease:Expo.easeInOut});	
				FWDR3DCarModTweenMax.to(self.mainButtonsHolder_do, .6, {h:0, ease:Expo.easeInOut});	
				FWDR3DCarModTweenMax.to(self, .6, {h:self.buttonHeight, ease:Expo.easeInOut});	
			}else{
		...
		this.show = function(animate, overwrite){
			...
			if(animate){
				FWDR3DCarModTweenMax.to(self.buttonsHolder_do, .6, {y:0, ease:Expo.easeInOut});
				FWDR3DCarModTweenMax.to(self.mainButtonsHolder_do, .6, {h:self.totalButtonsHeight + self.buttonHeight, ease:Expo.easeInOut});	
				FWDR3DCarModTweenMax.to(self, .6, {h:self.totalButtonsHeight + self.buttonHeight, ease:Expo.easeInOut});	
			}else{
		...
		this.destroy = function(){
			...
			FWDR3DCarModTweenMax.killTweensOf(self.mainHolder_do);
			FWDR3DCarModTweenMax.killTweensOf(self.buttonsHolder_do);	
			FWDR3DCarModTweenMax.killTweensOf(self.mainButtonsHolder_do);
			...
			self = null;
			prototype = null;
			FWDR3DCarComboBox.prototype = null;
		};
	};
	
	/* set prototype */
	FWDR3DCarComboBox.setPrototype =  function(){
		FWDR3DCarComboBox.prototype = new FWDR3DCarDisplayObject3D("div");
	};

	FWDR3DCarComboBox.OPEN = "open";
	FWDR3DCarComboBox.HIDE_COMPLETE = "infoWindowHideComplete";
	FWDR3DCarComboBox.BUTTON_PRESSED = "buttonPressed";

	FWDR3DCarComboBox.prototype = null;
	window.FWDR3DCarComboBox = FWDR3DCarComboBox;
...
/* FWDR3DCarComboBoxSelector */

(function (){
var FWDR3DCarComboBoxSelector = function(
			arrowW,
			arrowH,
			arrowN_str,
			arrowS_str,
		...
		var self = this;
		var prototype = FWDR3DCarComboBoxSelector.prototype;
		...
		self.setupMainContainers = function(){
			...
			self.arrowN_sdo = new FWDR3DCarSimpleDisplayObject("div");
			self.arrowN_sdo.screen.style.backgroundImage = "url(" + self.arrowN_str + ")";
			self.arrowS_sdo = new FWDR3DCarSimpleDisplayObject("div");
		...
		self.onMouseOver = function(e){
			...
			if(!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE){
				FWDR3DCarModTweenMax.killTweensOf(self.text_sdo);
				self.setSelectedState(true);
				self.dispatchEvent(FWDR3DCarComboBoxSelector.MOUSE_OVER);
			}
		};
		...
		self.onMouseOut = function(e){
			...
			if(!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE){
				FWDR3DCarModTweenMax.killTweensOf(self.text_sdo);
				self.setNormalState(true);
				self.dispatchEvent(FWDR3DCarComboBoxSelector.MOUSE_OUT);
			}
		};
		...
		self.onClick = function(e){
			...
			if(self.isDisabled_bl) return;
			if(e.preventDefault) e.preventDefault();
			self.dispatchEvent(FWDR3DCarComboBoxSelector.CLICK);
		};
		
		self.onMouseDown = function(e){
			if(self.isDisabled_bl) return;
			if(e.preventDefault) e.preventDefault();
			self.dispatchEvent(FWDR3DCarComboBoxSelector.MOUSE_DOWN, {e:e});
		};
		...
		this.setSelectedState = function(animate){
			if(animate){
				FWDR3DCarModTweenMax.to(self.colorObj, .6, {colorProps:{color1:self.backgroundSelectedColor_str1, color2:self.backgroundSelectedColor_str2}, ease:Quart.easeOut, onUpdate:self.applyProps});
				FWDR3DCarModTweenMax.to(self.text_sdo.screen, .6, {css:{color:self.textSelectedColor_str}, ease:Quart.easeOut});
				FWDR3DCarModTweenMax.to(self.arrowS_sdo, .6, {alpha:1, ease:Quart.easeOut});
			}else{
				self.bk_sdo.setCSSGradient(self.backgroundSelectedColor_str, self.backgroundNormalColor_str);
				self.text_sdo.getStyle().color = self.textSelectedColor_str;
		...
		this.setNormalState = function(animate){
			if(animate){
				FWDR3DCarModTweenMax.to(self.colorObj, .6, {colorProps:{color1:self.backgroundNormalColor_str1, color2:self.backgroundNormalColor_str2}, ease:Quart.easeOut, onUpdate:self.applyProps});
				FWDR3DCarModTweenMax.to(self.text_sdo.screen, .6, {css:{color:self.textNormalColor_str}, ease:Quart.easeOut});
				FWDR3DCarModTweenMax.to(self.arrowS_sdo, .6, {alpha:0, ease:Quart.easeOut});
			}else{
				self.bk_sdo.setCSSGradient(self.backgroundNormalColor_str, self.backgroundSelectedColor_str);
				self.text_sdo.getStyle().color = self.textNormalColor_str;
		...
		this.disable = function(){
			...
			if(FWDR3DCarUtils.hasTransform2d){
				FWDR3DCarModTweenMax.to(self.arrowN_sdo.screen, .6, {css:{rotation:180}, ease:Quart.easeOut});
				FWDR3DCarModTweenMax.to(self.arrowS_sdo.screen, .6, {css:{rotation:180}, ease:Quart.easeOut});
			}
			self.setButtonMode(false);
		};
		...
		this.enable = function(){
			...
			self.setNormalState(true);
			if(FWDR3DCarUtils.hasTransform2d){
				FWDR3DCarModTweenMax.to(self.arrowN_sdo.screen, .6, {css:{rotation:0}, ease:Quart.easeOut});
				FWDR3DCarModTweenMax.to(self.arrowS_sdo.screen, .6, {css:{rotation:0}, ease:Quart.easeOut});
			}
			self.setButtonMode(true);
		};
		...
		self.destroy = function(){
			...
			FWDR3DCarModTweenMax.killTweensOf(self.text_sdo);
			FWDR3DCarModTweenMax.killTweensOf(self.colorObj);
			self.text_sdo.destroy();
			...
			self = null;
			prototype = null;
			FWDR3DCarComboBoxSelector.prototype = null;
		};
	...
	/* set prototype */
	FWDR3DCarComboBoxSelector.setPrototype = function(){
		FWDR3DCarComboBoxSelector.prototype = new FWDR3DCarDisplayObject("div");
	};
	
	FWDR3DCarComboBoxSelector.FIRST_BUTTON_CLICK = "onFirstClick";
	FWDR3DCarComboBoxSelector.SECOND_BUTTON_CLICK = "secondButtonOnClick";
	FWDR3DCarComboBoxSelector.MOUSE_OVER = "onMouseOver";
	FWDR3DCarComboBoxSelector.MOUSE_OUT = "onMouseOut";
	FWDR3DCarComboBoxSelector.MOUSE_DOWN = "onMouseDown";
	FWDR3DCarComboBoxSelector.CLICK = "onClick";
	
	FWDR3DCarComboBoxSelector.prototype = null;
	window.FWDR3DCarComboBoxSelector = FWDR3DCarComboBoxSelector;
}(window));
/* FWDR3DCarComplexButton */

(function (window){
var FWDR3DCarComplexButton = function(
			n1Img, 
			s1Img, 
			n2Img, 
			s2Img, 
		...
		var self = this;
		var prototype = FWDR3DCarComplexButton.prototype;
		...
		this.onMouseOver = function(e){
			if(!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE){
				FWDR3DCarModTweenMax.killTweensOf(self.n1_do);
				FWDR3DCarModTweenMax.killTweensOf(self.n2_do);
				FWDR3DCarModTweenMax.to(self.n1_do, .8, {alpha:0, ease:Expo.easeOut});
				FWDR3DCarModTweenMax.to(self.n2_do, .8, {alpha:0, ease:Expo.easeOut});
			}
		};
		...
		this.onMouseOut = function(e){
			if(!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE){
				...
				FWDR3DCarModTweenMax.to(self.n1_do, .8, {alpha:1, delay:dl, ease:Expo.easeOut});	
				FWDR3DCarModTweenMax.to(self.n2_do, .8, {alpha:1, delay:dl, ease:Expo.easeOut});	
			}
		};
		
		this.onMouseDown = function(e){
			if(self.disptachMainEvent_bl){
				self.dispatchEvent(FWDR3DCarComplexButton.CLICK);
			}else{
		...
		this.toggleButton = function(){
			if(this.currentState == 1){
				...
				this.currentState = 0;
				this.dispatchEvent(FWDR3DCarComplexButton.SECOND_BUTTON_CLICK);
			}else{
				this.firstButton_do.setX(3000);
				this.secondButton_do.setX(0);
				this.currentState = 1;
				this.dispatchEvent(FWDR3DCarComplexButton.FIRST_BUTTON_CLICK);
			}
		};
		...
		this.destroy = function(){
			...
			self = null;
			prototype = null;
			FWDR3DCarComplexButton.prototype = null;
		};
	...
	/* set prototype */
	FWDR3DCarComplexButton.setPrototype = function(){
		FWDR3DCarComplexButton.prototype = new FWDR3DCarDisplayObject("div");
	};
	
	FWDR3DCarComplexButton.FIRST_BUTTON_CLICK = "onFirstClick";
	FWDR3DCarComplexButton.SECOND_BUTTON_CLICK = "secondButtonOnClick";
	FWDR3DCarComplexButton.CLICK = "onClick";
...
(function (){
	var FWDR3DCarContextMenu = function(e, showMenu){
		...
		this.mouseOverHandler = function(){
			...
			FWDR3DCarModTweenMax.to(self.normalMenu_do, .8, {alpha:0, ease:Expo.easeOut});
			FWDR3DCarModTweenMax.to(self.selectedMenu_do, .8, {alpha:1, ease:Expo.easeOut});
		};
		
		this.mouseOutHandler = function(){
			FWDR3DCarModTweenMax.to(self.normalMenu_do, .8, {alpha:1, ease:Expo.easeOut});
			FWDR3DCarModTweenMax.to(self.selectedMenu_do, .8, {alpha:0, ease:Expo.easeOut});
		};
		...
		this.destroy = function(){
			...
			if(this.menu_do){
				...
				FWDR3DCarModTweenMax.killTweensOf(self.selectedMenu_do);
...
(function (window){
	 ...
	 */
	var FWDR3DCarDisplayObject = function(type, position, overflow, display){
		...
		if(FWDR3DCarUtils.isFirefox) self.hasTransform3d_bl = false;
		if(FWDR3DCarUtils.isFirefox) self.hasTransform2d_bl = false;
		...
		this.setY = function(val){
			...
			if(self.isMobile_bl){
				self.screen.style[self.transform] = 'translate(' + self.x + 'px,' + self.y + 'px)';
			}else if(self.hasTransform3d_bl && !FWDR3DCarUtils.isAndroid){
				self.screen.style[self.transform] = 'translate3d(' + self.x + 'px,' + self.y + 'px,0)';
			}else if(self.hasTransform2d_bl){
				self.screen.style[self.transform] = 'translate(' + self.x + 'px,' + self.y + 'px)';
			}else{
		...
		this.addChildAtZero = function(e){
			if(this.numChildren == 0){
				...
				if(this.contains(e)){this.children_ar.splice(FWDR3DCarUtils.indexOfArray(this.children_ar, e), 1);}	
	...
	window.FWDR3DCarDisplayObject = FWDR3DCarDisplayObject;
}(window));
/* Display object */
...
(function (window){
	 ...
	 * @ display values: block, inline-block, this applies only if the position is relative.
	 */
	var FWDR3DCarDisplayObject3D = function(type, position, overflow, display){
	...
	window.FWDR3DCarDisplayObject3D = FWDR3DCarDisplayObject3D;
}(window));
(function (){
	
	var FWDR3DCarEventDispatcher = function (){
	...
	window.FWDR3DCarEventDispatcher = FWDR3DCarEventDispatcher;
}(window));
/* Info screen */
...
(function (window){
	...
	var FWDR3DCarInfoWindow = function(
			margins,
			backgroundColor_str,
			backgroundOpacity,
			borderRadius,
		...
		var self = this;
		var prototype = FWDR3DCarInfoWindow.prototype;
		...
		this.resize = function(maxWidth, maxHeight, animate){
			...
			FWDR3DCarModTweenMax.killTweensOf(self.obj);	
			if(animate){
				FWDR3DCarModTweenMax.to(self.obj, .8, {delay:.1, currentWidth:self.maxWidth, onUpdate:self.onTweenUpdate, ease:Expo.easeInOut});
			}else{
		...
		this.hide = function(animate){
			FWDR3DCarModTweenMax.killTweensOf(this);
			if(animate){
				FWDR3DCarModTweenMax.to(this, .6, {y:-this.finalHeight, ease:Expo.easeInOut, onComplete:this.hideComplete});
		...
		this.show = function(animate){
			...
			FWDR3DCarModTweenMax.killTweensOf(this);
			if(animate){
				FWDR3DCarModTweenMax.to(this, .6, {y:this.margins, ease:Expo.easeInOut});
			}else{
				this.setVisible(false);
				this.setY(this.margins);
			}
		...
		this.destroy = function(){
			...
			self = null;
			prototype = null;
			FWDR3DCarInfoWindow.prototype = null;
		};
	};
	
	/* set prototype */
	FWDR3DCarInfoWindow.setPrototype =  function(){
		FWDR3DCarInfoWindow.prototype = new FWDR3DCarDisplayObject("div");
	};


	FWDR3DCarInfoWindow.HIDE_COMPLETE = "infoWindowHideComplete";

	FWDR3DCarInfoWindow.prototype = null;
	window.FWDR3DCarInfoWindow = FWDR3DCarInfoWindow;
	
}(window));
(function (window){
	
	var FWDR3DCarLightBox = function(props){
		
		var self = this;
		var prototype = FWDR3DCarLightBox.prototype;
		...
		self.onScrollHandler = function(e){
			...
			var scrollOffsets = FWDR3DCarUtils.getScrollOffsets();
		...
		this.show = function(id){
			...
			FWDR3DCarModTweenMax.to(this.bk_do, .8, {alpha:this.backgroundOpacity, ease:Quint.easeOut, onComplete:this.onShowComplete});	
			this.showFirstTimeWithDelayId_to = setTimeout(function(){self.showCurrentItem();}, 100);
			
			this.dispatchEvent(FWDR3DCarLightBox.SHOW_START);
		};
		...
		this.showCurrentItem = function(){	 
			...
			if(this.data_ar[this.id].dataType.toLowerCase() == "iframe"){
				...
				this.type_str = FWDR3DCarLightBox.IFRAME;
				...
				this.type_str = FWDR3DCarLightBox.IMAGE;
				...
				this.type_str = FWDR3DCarLightBox.YOUTUBE;
				if(self.forceRoundBorderToIframe_bl && self.borderRadius != 0){
					self.itemsBorder_do.getStyle().borderRadius = self.borderRadius + "px";
				}else if(self.borderRadius != 0){
					 self.itemsBorder_do.getStyle().borderRadius = "0px";
				...
				this.type_str = FWDR3DCarLightBox.VIMEO;
				if(self.forceRoundBorderToIframe_bl && self.borderRadius != 0){
					self.itemsBorder_do.getStyle().borderRadius = self.borderRadius + "px";
				}else if(self.borderRadius != 0){
					 self.itemsBorder_do.getStyle().borderRadius = "0px";
		...
		this.createItem = function(){		
			...
			if(this.type_str == FWDR3DCarLightBox.IMAGE){
				if(this.prevItem_do){
				...
				this.loadImage();
			}else if(this.type_str == FWDR3DCarLightBox.YOUTUBE || this.type_str == FWDR3DCarLightBox.VIMEO || this.type_str == FWDR3DCarLightBox.IFRAME){
				...
				if(this.firstTimeShowed_bl){
					...
					if(this.prevItem_do){
						if(this.opacityType == "filter" && this.prevItem_do.type != "img"){
							...
							FWDR3DCarModTweenMax.to(this.prevItem_do, .8, {alpha:0});
						}	
					}
					...
					this.animMainDos();
					this.showVideoId_to = setTimeout(this.showIframeContent, 900);
					if(this.showZoomButton_bl && (this.type_str == FWDR3DCarLightBox.YOUTUBE || this.type_str == FWDR3DCarLightBox.VIMEO || self.type_str == FWDR3DCarLightBox.IFRAME)){
						var index = FWDR3DCarUtils.indexOfArray(this.buttons_ar, this.zoomButton_do);
						if(index != -1){
				...
				if(self.infoWindow_do){
					if(this.mainItemsHolder_do.contains(self.infoWindow_do) && this.infoWindow_do.isShowed_bl){
						this.infoWindow_do.setText(this.data_ar[self.id].infoText, this.finalWidth, this.finalHeight, false, this.type_str != FWDR3DCarLightBox.IMAGE);
					};
				}
			}
		...
		this.createIframeHolder = function(){
			...
			if(this.type_str == FWDR3DCarLightBox.IFRAME && this.isMobile_bl){
		...
		this.imageLoadComplete = function(e){
			...
			if(self.prevItem_do){
				if(!self.isMobile_bl && self.prevItem_do.type == "img") FWDR3DCarModTweenMax.to(self.prevItem_do, .6, {alpha:0});
			}
			
			self.originalWidth = self.image_img.width;
			self.originalHeight = self.image_img.height;
			
			self.currentItem_do = new FWDR3DCarDisplayObject("img");
			...
			if(self.firstTimeShowed_bl){
				...
				FWDR3DCarModTweenMax.to(self.currentItem_do, .6, {alpha:1, delay:.8});
			...
			if(self.infoWindow_do && self.infoWindow_do.isShowed_bl){
				self.infoWindow_do.setText(self.data_ar[self.id].infoText, self.finalWidth, self.finalHeight, true, self.type_str != FWDR3DCarLightBox.IMAGE);
			};
		...
		this.animMainDos = function(){
			FWDR3DCarModTweenMax.to(this.mainItemsHolder_do, .8, {delay:.1,x:self.finalX, y:self.finalY, w:self.finalWidth, h:self.finalHeight, ease:Expo.easeInOut});
			FWDR3DCarModTweenMax.to(this.itemsBackground_do, .8, {delay:.1, x:self.borderSize, y:self.borderSize, w:self.finalWidth - (self.borderSize * 2), h:self.finalHeight - (self.borderSize * 2), ease:Expo.easeInOut});
			FWDR3DCarModTweenMax.to(this.itemsBorder_do, .8, {delay:.1, w:self.finalWidth, h:self.finalHeight, ease:Expo.easeInOut});
			FWDR3DCarModTweenMax.to(this.itemsHolder_do, .8, {delay:.1, x:self.borderSize, y:self.borderSize, w:self.finalWidth - (self.borderSize * 2), h:self.finalHeight - (self.borderSize * 2), ease:Expo.easeInOut});
			if(!this.isMobile_bl && this.prevItem_do.type == "img") FWDR3DCarModTweenMax.to(self.prevItem_do, .8, {delay:.1, x: (self.finalWidth -  (self.borderSize * 2) - self.prevItem_do.getWidth())/2, y:(self.finalHeight -  (self.borderSize * 2) - self.prevItem_do.getHeight())/2, ease:Expo.easeInOut});
		};
		...
		this.showIframeContent = function(){
			...
			if(self.type_str == FWDR3DCarLightBox.YOUTUBE){
			...
			}else if(self.type_str == FWDR3DCarLightBox.VIMEO){
				if(self.videoAutoPlay_bl){
			...
			}else if(self.type_str == FWDR3DCarLightBox.IFRAME){
		...
		this.showItemFirstTime = function(){
			...
			FWDR3DCarModTweenMax.to(this.currentItem_do, .8, {alpha:1, delay:.9, ease:Quint.easeOut});
			FWDR3DCarModTweenMax.to(this.itemsBorder_do, .8, {alpha:1, delay:.7, ease:Quint.easeOut});
			FWDR3DCarModTweenMax.to(this.mainItemsHolder_do, .8, {x:this.finalX, y:this.finalY, w:this.finalWidth, h:this.finalHeight, ease:Expo.easeInOut});
		...
		this.cleanChildren = function(index){
			...
			while(self.itemsHolder_do.getNumChildren() > index){
				...
				FWDR3DCarModTweenMax.killTweensOf(child);
		...
		this.maximizeOrMinimize = function(){
			...
			if(this.isMaximized_bl){
				...
				FWDR3DCarModTweenMax.to(this.currentItem_do, .8, {x:0, y:0, w:this.finalWidth - (this.borderSize * 2), h:this.finalHeight - (this.borderSize * 2), ease:Expo.easeInOut});
				...
				this.dispatchEvent(FWDR3DCarLightBox.MINIMIZE_START);
			}else{
				...
				if(this.isMobile_bl){
					FWDR3DCarModTweenMax.to(this.zoomButton_do, .8, {x:this.stageWidth -  this.buttonWidth, y:1, ease:Expo.easeInOut});
					FWDR3DCarModTweenMax.to(this.currentItem_do, .8, { x:finalX, y:finalY, w:finalWidth, h:finalHeight, ease:Expo.easeInOut});
				}else{
					this.zoomButton_do.isMaximized_bl = true;
					if(scaleX >= scaleY){
						FWDR3DCarModTweenMax.to(this.currentItem_do, .8, {x:finalX, w:finalWidth, h:finalHeight, ease:Expo.easeInOut});
					}else if(scaleX < scaleY){
						FWDR3DCarModTweenMax.to(this.currentItem_do, .8, {y:finalY, w:finalWidth, h:finalHeight, ease:Expo.easeInOut});
					}
		...
		this.maximizeCompleteHandler = function(){
			...
			self.dispatchEvent(FWDR3DCarLightBox.MAXIMIZE_COMPLETE);
		...
		this.updateMaximizeImageOnMouseMovedHandler = function(e){
			...
			FWDR3DCarModTweenMax.to(self.zoomButton_do, .2, {x:self.globalXMousePosition - parseInt(self.buttonWidth/2), y:self.globalYMousePosition - parseInt(self.buttonHeight/2)});
		};
		...
		this.updateMaximizedImageHandler = function(){
			...
			if(scaleX <= scaleY){
				...
				FWDR3DCarModTweenMax.to(self.currentItem_do, .4, {x:targetX});
			}else {
				targetY = Math.round(((self.stageHeight - self.currentItem_do.getHeight()) * self.percentY));
				if(isNaN(targetY)) return;
				FWDR3DCarModTweenMax.to(self.currentItem_do, .4, {y:targetY});
			}
		};
		...
		this.onShowInfoButtonPressedHandler = function(e){
			self.infoWindow_do.setText(self.data_ar[self.id].infoText, self.finalWidth, self.finalHeight, false, self.type_str != FWDR3DCarLightBox.IMAGE);
		...
		this.positionSlideShowPreloader = function(animate){
			...
			if(animate){
				FWDR3DCarModTweenMax.to(this.slideShowPreloader_do, .8, {x:this.slideShowPreloader_do.finalX, y:this.slideShowPreloader_do.finalY, delay:.1, ease:Expo.easeInOut});
			}else{
		...
		this.positionButtons = function(animate){
			...
			for(var i=0; i<totalButtons; i++){
				...
				FWDR3DCarModTweenMax.killTweensOf(button);
				...
				if(button){
					if(animate){
						FWDR3DCarModTweenMax.to(button, .8, {x:button.finalX, y:button.finalY, delay:.1, ease:Expo.easeInOut});
					}else{
			...
			if(this.showNextAndPrevButtons_bl){
				...
				if(animate){
					FWDR3DCarModTweenMax.to(this.prevButton_do, .8, {x:this.finalX - this.buttonWidth, y:Math.round((this.stageHeight - this.buttonHeight)/2), delay:.1, ease:Expo.easeInOut});
				}else{
		...
		this.hide = function(){
			...
			if(this.type_str == FWDR3DCarLightBox.YOUTUBE || this.type_str == FWDR3DCarLightBox.VIMEO || self.type_str == FWDR3DCarLightBox.IFRAME){
				...
				FWDR3DCarModTweenMax.to(this.itemsBorder_do, .9, {alpha:0, ease:Quint.easeOut});
				FWDR3DCarModTweenMax.to(this.mainItemsHolder_do, .9, {x:this.stageWidth/2, y:this.stageHeight/2, w:0, h:0, ease:Expo.easeInOut});
				FWDR3DCarModTweenMax.to(this.bk_do, .9, {alpha:0, delay:.9, ease:Quint.easeOut, onComplete:this.onHideComplete});
			}else if(this.type_str == FWDR3DCarLightBox.IMAGE){
				if(this.currentItem_do && this.currentItem_do.screen){
					FWDR3DCarModTweenMax.killTweensOf(this.currentItem_do);
					FWDR3DCarModTweenMax.to(this.currentItem_do, .7, {alpha:0, ease:Quint.easeOut});
				}
				
				FWDR3DCarModTweenMax.to(this.itemsBorder_do, .9, {alpha:0, delay:.1, ease:Quint.easeOut});
				FWDR3DCarModTweenMax.to(this.mainItemsHolder_do, .9, {x:this.stageWidth/2, y:this.stageHeight/2, w:0, h:0, delay:.2, ease:Expo.easeInOut});
				FWDR3DCarModTweenMax.to(this.bk_do, .9, {alpha:0, delay:1.2, ease:Quint.easeOut, onComplete:this.onHideComplete});
			}
			...
			this.isTweening_bl = true;
			this.firstTimeShowed_bl = true;
			self.dispatchEvent(FWDR3DCarLightBox.HIDE_START);
		};
		
		this.hideButtons = function(animate){
			if(animate){
				FWDR3DCarModTweenMax.to(this.closeButton_do, .8, {x:this.stageWidth, ease:Expo.easeInOut});
				if(this.infoButton_do) FWDR3DCarModTweenMax.to(this.infoButton_do, .8, {x:this.stageWidth, ease:Expo.easeInOut});
				if(this.slideshowButtton_do) FWDR3DCarModTweenMax.to(this.slideshowButtton_do, .8, {x:this.stageWidth, ease:Expo.easeInOut});
				if(this.zoomButton_do) FWDR3DCarModTweenMax.to(this.zoomButton_do, .8, {x:this.stageWidth, ease:Expo.easeInOut});
				if(this.nextButton_do){
					FWDR3DCarModTweenMax.to(this.nextButton_do, .8, {x:this.stageWidth, ease:Expo.easeInOut});
					FWDR3DCarModTweenMax.to(this.prevButton_do, .8, {x:- this.buttonWidth, ease:Expo.easeInOut});
				}
				if(this.slideShowPreloader_do) FWDR3DCarModTweenMax.to(this.slideShowPreloader_do, .8, {x:this.stageWidth, ease:Expo.easeInOut});
			}else{
		...
		this.showButtons = function(){
			...
			if(this.zoomButton_do && (this.type_str != FWDR3DCarLightBox.YOUTUBE || this.type_str != FWDR3DCarLightBox.VIMEO || self.type_str == FWDR3DCarLightBox.IFRAME)){
		...
		this.onHideComplete = function(){
			...
			self.dispatchEvent(FWDR3DCarLightBox.HIDE_COMPLETE);
		};
		...
		this.destroy = function(){
			...
			self = null;
			prototype = null;
			FWDR3DCarLightBox.prototype = null;
		};
	...
	/* set prototype */
	FWDR3DCarLightBox.setPrototype =  function(){
		FWDR3DCarLightBox.prototype = new FWDR3DCarDisplayObject("div");
	};

	FWDR3DCarLightBox.YOUTUBE = "youtube";
	FWDR3DCarLightBox.VIMEO = "vimeo";
	FWDR3DCarLightBox.IMAGE = "image_img";
	FWDR3DCarLightBox.IFRAME = "htmlIframe";
	FWDR3DCarLightBox.MAXIMIZE_COMPLETE = "maximizeComplete";
	FWDR3DCarLightBox.MINIMIZE_START = "minimizeStart";
	FWDR3DCarLightBox.SHOW_START = "showStart";
	FWDR3DCarLightBox.HIDE_COMPLETE = "hideComplete";
	FWDR3DCarLightBox.HIDE_START = "hideStart";
	
	
	FWDR3DCarLightBox.prototype = null;
	window.FWDR3DCarLightBox = FWDR3DCarLightBox;
 ...
 * UPDATES AND DOCS AT: http://www.greensock.com
 * 
 * Includes all of the following: TweenLite, FWDR3DCarModTweenMax, TimelineLite, TimelineMax, EasePack, CSSPlugin, RoundPropsPlugin, BezierPlugin, AttrPlugin, DirectionalRotationPlugin
 *
 * @license Copyright (c) 2008-2013, GreenSock. All rights reserved.
 * This work is subject to the terms at http://www.greensock.com/terms_of_use.html or for
 * Club GreenSock members, the software agreement that was issued with your membership.
...
(window._gsQueue || (window._gsQueue = [])).push( function() {
	...
	window._gsDefine("FWDR3DCarModTweenMax", ["core.Animation","core.SimpleTimeline","TweenLite"], function(Animation, SimpleTimeline, TweenLite) {
		
		var _slice = [].slice,
			FWDR3DCarModTweenMax = function(target, duration, vars) {
			...
			p = FWDR3DCarModTweenMax.prototype = TweenLite.to({}, 0.1, {}),
			_blankArray = [];

		FWDR3DCarModTweenMax.version = "1.9.7";
		p.constructor = FWDR3DCarModTweenMax;
		p.kill()._gc = false;
		FWDR3DCarModTweenMax.killTweensOf = FWDR3DCarModTweenMax.killDelayedCallsTo = TweenLite.killTweensOf;
		FWDR3DCarModTweenMax.getTweensOf = TweenLite.getTweensOf;
		FWDR3DCarModTweenMax.ticker = TweenLite.ticker;
...
//---- STATIC FUNCTIONS -----------------------------------------------------------------------------------------------------------
		...
		FWDR3DCarModTweenMax.to = function(target, duration, vars) {
			return new FWDR3DCarModTweenMax(target, duration, vars);
		};
		
		FWDR3DCarModTweenMax.from = function(target, duration, vars) {
			vars.runBackwards = true;
			vars.immediateRender = (vars.immediateRender != false);
			return new FWDR3DCarModTweenMax(target, duration, vars);
		};
		
		FWDR3DCarModTweenMax.fromTo = function(target, duration, fromVars, toVars) {
			toVars.startAt = fromVars;
			toVars.immediateRender = (toVars.immediateRender != false && fromVars.immediateRender != false);
			return new FWDR3DCarModTweenMax(target, duration, toVars);
		};
		
		FWDR3DCarModTweenMax.staggerTo = FWDR3DCarModTweenMax.allTo = function(targets, duration, vars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope) {
			stagger = stagger || 0;
			...
			for (i = 0; i < l; i++) {
				...
				a[i] = new FWDR3DCarModTweenMax(targets[i], duration, copy);
				delay += stagger;
			}
			return a;
		};
		
		FWDR3DCarModTweenMax.staggerFrom = FWDR3DCarModTweenMax.allFrom = function(targets, duration, vars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope) {
			vars.runBackwards = true;
			vars.immediateRender = (vars.immediateRender != false);
			return FWDR3DCarModTweenMax.staggerTo(targets, duration, vars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope);
		};
		
		FWDR3DCarModTweenMax.staggerFromTo = FWDR3DCarModTweenMax.allFromTo = function(targets, duration, fromVars, toVars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope) {
			toVars.startAt = fromVars;
			toVars.immediateRender = (toVars.immediateRender != false && fromVars.immediateRender != false);
			return FWDR3DCarModTweenMax.staggerTo(targets, duration, toVars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope);
		};
				
		FWDR3DCarModTweenMax.delayedCall = function(delay, callback, params, scope, useFrames) {
			return new FWDR3DCarModTweenMax(callback, 0, {delay:delay, onComplete:callback, onCompleteParams:params, onCompleteScope:scope, onReverseComplete:callback, onReverseCompleteParams:params, onReverseCompleteScope:scope, immediateRender:false, useFrames:useFrames, overwrite:0});
		};
		
		FWDR3DCarModTweenMax.set = function(target, vars) {
			return new FWDR3DCarModTweenMax(target, 0, vars);
		};
		
		FWDR3DCarModTweenMax.isTweening = function(target) {
		...
		var _getChildrenOf = function(timeline, includeTimelines) {
			...
			getAllTweens = FWDR3DCarModTweenMax.getAllTweens = function(includeTimelines) {
				return _getChildrenOf(Animation._rootTimeline, includeTimelines).concat( _getChildrenOf(Animation._rootFramesTimeline, includeTimelines) );
			};
		
		FWDR3DCarModTweenMax.killAll = function(complete, tweens, delayedCalls, timelines) {
			if (tweens == null) {
				tweens = true;
			}
		...
		FWDR3DCarModTweenMax.killChildTweensOf = function(parent, complete) {
			if (parent == null) {
				return;
			}
			...
			if (parent instanceof Array) {
				i = parent.length;
				while (--i > -1) {
					FWDR3DCarModTweenMax.killChildTweensOf(parent[i], complete);
				}
				return;
			}
			a = [];
		...
		FWDR3DCarModTweenMax.pauseAll = function(tweens, delayedCalls, timelines) {
			_changePause(true, tweens, delayedCalls, timelines);
		};
		
		FWDR3DCarModTweenMax.resumeAll = function(tweens, delayedCalls, timelines) {
...
//---- GETTERS / SETTERS ----------------------------------------------------------------------------------------------------------
		...
		p.duration = function(value) {
			if (!arguments.length) {
				return this._duration; //don't set _dirty = false because there could be repeats that haven't been factored into the _totalDuration yet. Otherwise, if you create a repeated FWDR3DCarModTweenMax and then immediately check its duration(), it would cache the value and the totalDuration would not be correct, thus repeats wouldn't take effect.
			}
...
(function(window) {
		...
		var _globals = window.GreenSockGlobals || window,
			 ...
			 * </script>
			 * <script src="js/greensock/v1.7/FWDR3DCarModTweenMax.js"></script>
			 * <script>
			 *     window.GreenSockGlobals = null; //reset it back to null so that the next load of FWDR3DCarModTweenMax affects the window and we can reference things directly like TweenLite.to(...)
			 * </script>
			 * <script src="js/greensock/v1.6/FWDR3DCarModTweenMax.js"></script>
			 * <script>
...
//----Animation getters/setters --------------------------------------------------------
		...
		p.duration = function(value) {
			...
			this._uncache(true); //true in case it's a FWDR3DCarModTweenMax or TimelineMax that has a repeat - we'll need to refresh the totalDuration.
...
(function(window)
{
	var FWDR3DCarScrollbar = function(data, totalItems, curItemId)
	{
		var self = this;
		var prototype = FWDR3DCarScrollbar.prototype;
		...
		{
			self.scrollbarTrackDO = new FWDR3DCarDisplayObject("div");
			...
			self.scrollbarTrackLeftDO = new FWDR3DCarSimpleDisplayObject("img");
			self.scrollbarTrackLeftDO.setScreen(self.trackLeftImg);
			self.scrollbarTrackDO.addChild(self.scrollbarTrackLeftDO);
			
			self.scrollbarTrackCenterDO = new FWDR3DCarSimpleDisplayObject("div");
			...
			self.scrollbarTrackRightDO = new FWDR3DCarSimpleDisplayObject("img");
		...
		{
			self.scrollbarHandlerDO = new FWDR3DCarDisplayObject("div");
			...
			self.scrollbarHandlerCenterNDO = new FWDR3DCarSimpleDisplayObject("div");
			...
			self.scrollbarHandlerRightSDO = new FWDR3DCarSimpleDisplayObject("img");
			...
			self.scrollbarHandlerRightNDO = new FWDR3DCarSimpleDisplayObject("img");
			...
			self.scrollbarHandlerTextDO = new FWDR3DCarDisplayObject("div");
			...
			self.scrollbarHandlerOverDO = new FWDR3DCarDisplayObject("div");
		...
		this.onScrollMouseOver = function()
		{
			...
			FWDR3DCarModTweenMax.to(self.scrollbarHandlerLeftNDO, .8, {alpha:0, ease : Expo.easeOut});
			FWDR3DCarModTweenMax.to(self.scrollbarHandlerCenterNDO, .8, {alpha:0, ease : Expo.easeOut});
			FWDR3DCarModTweenMax.to(self.scrollbarHandlerRightNDO, .8, {alpha:0, ease : Expo.easeOut});
			FWDR3DCarModTweenMax.to(self.scrollbarHandlerTextDO.screen, .8, {css : {color : self.textColorSelected}, ease : Expo.easeOut});
		};
		...
		this.onScrollMouseOut = function()
		{
			...
			FWDR3DCarModTweenMax.to(self.scrollbarHandlerLeftNDO, .8, {alpha:1, ease : Expo.easeOut});
			FWDR3DCarModTweenMax.to(self.scrollbarHandlerCenterNDO, .8, {alpha:1, ease : Expo.easeOut});
			FWDR3DCarModTweenMax.to(self.scrollbarHandlerRightNDO, .8, {alpha:1, ease : Expo.easeOut});
			FWDR3DCarModTweenMax.to(self.scrollbarHandlerTextDO.screen, .8, {css : {color : self.textColorNormal}, ease : Expo.easeOut});
		};
		...
		this.onScrollMouseDown = function(e)
		{
			...
			FWDR3DCarModTweenMax.killTweensOf(self.scrollbarHandlerDO);
		...
		this.onScrollMove = function(e)
		{
			...
			{
				self.dispatchEvent(FWDR3DCarScrollbar.MOVE, {id:self.curItemId});
		...
		this.gotoItem = function(id, animate)
		{
			...
			if (self.prevCurItemId != self.curItemId)
			{
				...
				{
					FWDR3DCarModTweenMax.killTweensOf(self.scrollbarHandlerDO);
					FWDR3DCarModTweenMax.to(self.scrollbarHandlerDO, .8, {x : Math.floor(self.curItemId * (self.trackWidth - self.handlerWidth) / (self.totalItems - 1)), ease : Expo.easeOut});
				}
				else
				{
					self.scrollbarHandlerDO.setX(Math.floor(self.curItemId * (self.trackWidth - self.handlerWidth) / (self.totalItems - 1)));
		...
		this.destroy = function()
		{
			...
			FWDR3DCarModTweenMax.killTweensOf(self.scrollbarHandlerLeftNDO);
			FWDR3DCarModTweenMax.killTweensOf(self.scrollbarHandlerCenterNDO);
			FWDR3DCarModTweenMax.killTweensOf(self.scrollbarHandlerRightNDO);
			FWDR3DCarModTweenMax.killTweensOf(self.scrollbarHandlerDO);
			FWDR3DCarModTweenMax.killTweensOf(self.scrollbarHandlerTextDO.screen);
			...
			self = null;
			prototype = null;
			FWDR3DCarScrollbar.prototype = null;
		};
	...
	/* set prototype */
	FWDR3DCarScrollbar.setPrototype = function()
	{
		FWDR3DCarScrollbar.prototype = null;
		FWDR3DCarScrollbar.prototype = new FWDR3DCarDisplayObject("div");
	};

	FWDR3DCarScrollbar.MOVE = "onMove";

	FWDR3DCarScrollbar.prototype = null;
	window.FWDR3DCarScrollbar = FWDR3DCarScrollbar;
}(window));
...
(function (window){
	 ...
	 */
	var FWDR3DCarSimpleDisplayObject = function(type, position, overflow, display){
	...
	window.FWDR3DCarSimpleDisplayObject = FWDR3DCarSimpleDisplayObject;
}(window));
/* Slideshow preloader */
...
/* FWDR3DCarSlideshowButton */

(function(window)
{
	var FWDR3DCarSlideshowButton = function(data)
	{
		var self = this;
		var prototype = FWDR3DCarSlideshowButton.prototype;
		...
		{
			self.pauseButtonDO = new FWDR3DCarSimpleDisplayObject("img");
		...
		{
			self.playButtonDO = new FWDR3DCarDisplayObject("div");
			self.addChild(self.playButtonDO);
			
			self.playButtonSDO = new FWDR3DCarSimpleDisplayObject("img");
			self.playButtonSDO.setScreen(self.playButtonSImg);
			self.playButtonDO.addChild(self.playButtonSDO);
			
			self.playButtonNDO = new FWDR3DCarSimpleDisplayObject("img");
		...
		this.onMouseOver = function()
		{
			if (self.isPlaying)
			{
				FWDR3DCarModTweenMax.to(self.timerButtonDO, .8, {alpha:0, ease : Expo.easeOut});
			}
			else
			{
				FWDR3DCarModTweenMax.to(self.playButtonNDO, .8, {alpha:0, ease : Expo.easeOut});
			}
		};
		...
		this.onMouseOut = function()
		{
			if (self.isPlaying)
			{
				FWDR3DCarModTweenMax.to(self.timerButtonDO, .8, {alpha:1, ease : Expo.easeOut});
			}
			else
			{
				FWDR3DCarModTweenMax.to(self.playButtonNDO, .8, {alpha:1, ease : Expo.easeOut});
			}
		};
		...
		this.onClick = function(e)
		{
			if (self.isPlaying)
			{
				...
				self.dispatchEvent(FWDR3DCarSlideshowButton.PAUSE_CLICK);
			}
			else
			{
				self.start();
				
				self.dispatchEvent(FWDR3DCarSlideshowButton.PLAY_CLICK);
			}
		...
		this.onTimeHandler = function()
		{
			...
			self.onTickHandler();
			self.dispatchEvent(FWDR3DCarSlideshowButton.TIME);
		};
		...
		this.destroy = function()
		{
			...
			FWDR3DCarModTweenMax.killTweensOf(self.timerButtonDO);
			FWDR3DCarModTweenMax.killTweensOf(self.playButtonNDO);
			...
			self = null;
			prototype = null;
			FWDR3DCarSlideshowButton.prototype = null;
		};
	...
	/* set prototype */
	FWDR3DCarSlideshowButton.setPrototype = function()
	{
		FWDR3DCarSlideshowButton.prototype = new FWDR3DCarDisplayObject("div");
	};

	FWDR3DCarSlideshowButton.PLAY_CLICK = "onPlayClick";
	FWDR3DCarSlideshowButton.PAUSE_CLICK = "onPauseClick";
	FWDR3DCarSlideshowButton.TIME = "onTime";

	FWDR3DCarSlideshowButton.prototype = null;
	window.FWDR3DCarSlideshowButton = FWDR3DCarSlideshowButton;
}(window));
/* thumb */
...
(function(window)
{
	var FWDRoyal3DCarousel = function(props)
	{
		var self = this;
		...
		this.init = function()
		{
			...
			if (!FWDR3DCarUtils.getChildById(self.propsObj.carouselHolderDivId))
			{
				alert("FWDRoyal3DCarousel holder div is not found, please make sure that the div exists and the id is correct! " + self.propsObj.carouselHolderDivId);
				return;
			}
			...
			self.stageContainer = FWDR3DCarUtils.getChildById(self.propsObj.carouselHolderDivId);
		...
		{
			self.mainDO = new FWDR3DCarDisplayObject("div", "relative");
			...
			if (self.displayType == FWDRoyal3DCarousel.FLUID_WIDTH)
			{	
		...
		this.setBackgrounds = function()
		{
			...
			{
				self.bgDO = new FWDR3DCarDisplayObject("div");
				self.mainDO.addChild(self.bgDO);
				...
				FWDR3DCarModTweenMax.to(self.bgDO, .8, {alpha:1});
			}

			if (self.propsObj.thumbnailsBackgroundImagePath)
			{
				self.thumbsBgDO = new FWDR3DCarDisplayObject("div");
				...
				FWDR3DCarModTweenMax.to(self.thumbsBgDO, .8, {alpha:1});
			}

			if (self.propsObj.scrollbarBackgroundImagePath)
			{
				self.scrollbarBgDO = new FWDR3DCarDisplayObject("div");
				...
				FWDR3DCarModTweenMax.to(self.scrollbarBgDO, .8, {alpha:1});
			}
		};
		...
		this.resizeHandler = function()
		{
			...
			if (self.preloaderLoaded)
			{
				if (self.propsObj.backgroundImagePath)
				{
					if (self.displayType == FWDRoyal3DCarousel.RESPONSIVE)
					{
		...
		this.setupData = function()
		{
			...
			self.data = new FWDR3DCarData(self.propsObj);
			self.data.addListener(FWDR3DCarData.PRELOADER_LOAD_DONE, self.onPreloaderLoadDone);
			self.data.addListener(FWDR3DCarData.LOAD_ERROR, self.dataLoadError);
			self.data.addListener(FWDR3DCarData.LOAD_DONE, self.dataLoadComplete);
		};
		...
		{
			self.dispatchEvent(FWDRoyal3DCarousel.DATA_LOADED);
		...
		this.setupPreloader = function()
		{
			...
			self.preloaderDO = new FWDR3DCarPreloader(self.data.mainPreloaderImg, 70, 40, 12, 50);
		...
		this.setupThumbsManager = function()
		{
			...
			self.thumbsManagerDO = new FWDR3DCarThumbsManager(self.data, self);
			self.thumbsManagerDO.addListener(FWDR3DCarThumbsManager.THUMB_CLICK, self.onThumbsManagerThumbClick);
			self.thumbsManagerDO.addListener(FWDR3DCarThumbsManager.LOAD_ERROR, self.onThumbsManagerLoadError);
			self.thumbsManagerDO.addListener(FWDR3DCarThumbsManager.THUMBS_INTRO_FINISH, self.onThumbsManagerIntroFinish);
			self.thumbsManagerDO.addListener(FWDR3DCarThumbsManager.THUMB_CHANGE, self.onThumbsManagerThumbChange);
		...
		{
			self.enableAll();
			self.dispatchEvent(FWDRoyal3DCarousel.INTRO_FINISH);
			
			self.apiReady = true;
			self.dispatchEvent(FWDRoyal3DCarousel.IS_API_READY);
			
			self.dispatchEvent(FWDRoyal3DCarousel.CATEGORY_CHANGE, {id:self.thumbsManagerDO.dataListId});
		};
		
		this.onThumbsManagerThumbChange = function(e)
		{
			self.dispatchEvent(FWDRoyal3DCarousel.THUMB_CHANGE, {id:e.id});
		};
		...
		this.setupComboBox = function()
		{
			...
			self.comboBoxDO = new FWDR3DCarComboBox(self, 
			{
			...
			self.comboBoxDO.addListener(FWDR3DCarComboBox.BUTTON_PRESSED, self.onComboboxButtonPressHandler);
		...
		this.onComboboxButtonPressHandler = function(e)
		{
			if (self.thumbsManagerDO.allowToSwitchCat)
			{
				...
				self.dispatchEvent(FWDRoyal3DCarousel.INTRO_START);
		...
		{
			self.disableDO = new FWDR3DCarDisplayObject3D("div");
	   ...
	   this.removeListener = function(type, listener)
	   {
		...
		this.destroy = function()
		{
			...
			if (self.thumbsBgDO)
			{
				FWDR3DCarModTweenMax.killTweensOf(self.thumbsBgDO);
				self.thumbsBgDO.destroy();
			}
			
			if (self.scrollbarBgDO)
			{
				FWDR3DCarModTweenMax.killTweensOf(self.scrollbarBgDO);
	...
	FWDRoyal3DCarousel.RESIZE = "resize";
	FWDRoyal3DCarousel.LIGHTBOX = "lightbox";
	FWDRoyal3DCarousel.RESPONSIVE = "responsive";
	FWDRoyal3DCarousel.FLUID_WIDTH = "fluidwidth";
	
	FWDRoyal3DCarousel.INTRO_START = "onIntroStart";
	FWDRoyal3DCarousel.INTRO_FINISH = "onIntroFinish";
	FWDRoyal3DCarousel.DATA_LOADED = "onDataLoaded";
	FWDRoyal3DCarousel.IS_API_READY = "isAPIReady";
	FWDRoyal3DCarousel.CATEGORY_CHANGE = "categoryChanged";
	FWDRoyal3DCarousel.THUMB_CHANGE = "thumbChanged";
	
	
	window.FWDRoyal3DCarousel = FWDRoyal3DCarousel;
